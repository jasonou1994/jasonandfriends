...
public class pageGenerator {
	public static void main(String[] args) throws IOException {
		...
		String allSettingsString = readFile("/users/jasonou/documents/jasonandfriends/generatorSettings.txt",
	...
	static void generateHTML(String pageString) throws IOException
	{
		...
		{
			String photoTemp = photoTemplate.replaceAll("photo1", center[i]);
		...
		{
			String photoTemp = photoTemplate.replaceAll("photo1", left[i]);
		...
		{
			String photoTemp = photoTemplate.replaceAll("photo1", right[i]);
